...
const CreatePage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      router.push(`/profile/events/${response.data.id}`);
  ...
  return (
    <div className="max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6">
      <div>
        ...
        <p className="text-sm text-slate-600">What would you like to name your event? Don&apos;t worry, you can change this later.</p>
        <Form {...form}>
